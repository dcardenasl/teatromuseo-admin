...
/** Normalizes the single-read Catalog technique workspace. */
final class CatalogTechniqueBffAdapter
{
    ...
    public function workspace(?int $techniqueId = null): ?array
    {
        $response = $this->bffApiClient->getAdminCatalogTechniqueWorkspace($techniqueId);
