    ...
    <aside class="space-y-6">
        <?= view('components/display/admin_actions_panel', [
            'content' => '<button type="submit" class="' . esc(action_button_class('primary'), 'attr') . ' w-full justify-center text-center py-2.5">' . esc(lang('App.save')) . '</button>'
                . (has_permission('catalog.collectionItem.delete') ? '<button type="submit" form="delete-item-form" class="' . esc(action_button_class('danger'), 'attr') . ' w-full justify-center text-center py-2.5 mt-2">' . esc(lang('App.delete')) . '</button>' : '')
