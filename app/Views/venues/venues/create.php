<?= view('components/display/admin_page_header', [
    ...
    'title' => 'Venues.venues_create',
]) ?>

<form method="post" action="<?= route_to('admin.venues.venues.store') ?>" class="grid grid-cols-1 gap-6 lg:grid-cols-3">
    <?= csrf_field() ?>

    <div class="lg:col-span-2">
        <section class="bg-white border border-gray-200 rounded-xl shadow-sm p-5">
            <h3 class="text-lg font-semibold text-gray-900"><?= esc(lang('Venues.venues_create')) ?></h3>
