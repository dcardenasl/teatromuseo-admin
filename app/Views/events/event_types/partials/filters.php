...
<div class="mt-3 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
    <div class="xl:col-span-2">
        ...
        <input type="text" name="search" value="<?= esc((string) request()->getGet('search')) ?>" placeholder="<?= esc(lang('Events.field_event_type_name')) ?>" class="<?= esc(filter_input_class()) ?>" data-table-debounce="350">
    </div>
