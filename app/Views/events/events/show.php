    ...
    <section class="bg-white border border-gray-200 rounded-xl shadow-sm">
        ...
        <dl class="divide-y divide-gray-100">
            ...
            <?= view('components/display/field_row', [
                ...
                'value' => ! empty($event['event_type']) ? '<span class="inline-flex items-center rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10">' . esc($event['event_type']) . '</span>' : '—',
                'isHtml' => true
            ]) ?>
            <?= view('components/display/field_row', [
            ...
            <?= view('components/display/field_row', [
                ...
                'value' => ! empty($event['status']) ? '<span class="inline-flex items-center rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10">' . esc($event['status']) . '</span>' : '—',
                'isHtml' => true
            ]) ?>
            <?= view('components/display/field_row', [
