...
<div x-data="collectionBlockTemplateBuilder(<?= esc($blockTypesJson, 'attr') ?>, <?= esc($initialJson, 'attr') ?>, <?= esc($collectionPresetsJson, 'attr') ?>, <?= esc($initialWizardConfigJson, 'attr') ?>, <?= esc($wizardFieldCatalogJson, 'attr') ?>, <?= esc($builderUiLabelsJson, 'attr') ?>)" class="space-y-6">
