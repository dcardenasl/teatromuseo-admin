                    ...
                    <div class="rounded-xl border border-gray-200 bg-gray-50 overflow-hidden divide-y divide-gray-200">
                        <?php foreach ($languages as $key => $lang): ?>
                            ...
                            $fields = [
                                ...
                                [
                                    'from' => 'input[name="translations[' . $defaultLangIndex . '][custom_url]"]',
                                    'to' => 'input[name="translations[' . $fieldIndex . '][custom_url]"]'
                                ]
                            ];
                            ?>
            ...
            <div class="rounded-xl border border-gray-200 bg-gray-50 p-4 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="icon" value="<?= esc(old('icon', $item['icon'] ?? '')) ?>" maxlength="50"
                ...
                <div>
                    ...
                    <input type="text" name="css_class" value="<?= esc(old('css_class', $item['css_class'] ?? '')) ?>" maxlength="100"
