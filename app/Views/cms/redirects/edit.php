...
<?= view('components/display/admin_page_header', [
    ...
    'title' => 'Redirects.redirects_edit',
    'subtitle' => (string) ($item['old_path'] ?? ''),
]) ?>

<form method="post" action="<?= route_to('admin.cms.redirects.update', $itemId) ?>" class="grid grid-cols-1 gap-6 lg:grid-cols-3">
    <?= csrf_field() ?>
