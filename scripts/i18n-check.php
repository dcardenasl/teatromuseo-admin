...
/**
 * i18n-check — admin-starter (audit B8.3, 2026-05-06)
 *
 ...
 *
 * Adapted from `ci4-api-starter/scripts/i18n-check.php` but trimmed to
 * just the parity checks; admin doesn't have the same surface of
 * hardcoded-exception scans because the API is the source of error
 * messages we localize.
 */
