...
/**
 * Guardrail to enforce that the Admin application remains completely stateless.
 *
...
final class StatelessArchitectureTest extends CIUnitTestCase
{
    ...
    public function testCodebaseIsCompletelyStateless(): void
    {
        ...
        foreach ($iterator as $file) {
            ...
            // Strip comments and string literals to prevent false positives in comments/docs
            $code = '';
        ...
        $this->assertSame(
            [],
            $violations,
            "Stateless architecture violations found in teatromuseo-admin:\n- " . implode("\n- ", $violations) . "\n\n" .
            "The Admin app must remain completely database-free and model-free. All data access must go through API Services."
        );
    }
}
