 ...
 * @internal
 */
final class CategoryApiServiceTest extends CIUnitTestCase
{
    public function testListCallsCorrectEndpoint(): void
    {
        ...
        $service = new CategoryApiService($mock);
