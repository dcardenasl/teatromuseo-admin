...
final class BookingFlowTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/admin/bookings/bookings');
    ...
    {
        $mock = $this->createMock(BookingApiService::class);
        ...
        Services::injectMock('bookingApiService', $mock);
        ...
        $result->assertRedirectTo(site_url('admin/bookings/bookings'));
    }
}
