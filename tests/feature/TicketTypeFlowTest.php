 ...
 * @internal
 */
final class TicketTypeFlowTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/admin/tickettypes/ticket-types');
    ...
    {
        $mock = $this->createMock(TicketTypeApiService::class);
        ...
        Services::injectMock('ticketTypeApiService', $mock);
        ...
        $result->assertRedirectTo(site_url('admin/tickettypes/ticket-types'));
    }
}
