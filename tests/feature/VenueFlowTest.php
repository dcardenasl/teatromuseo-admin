 ...
 * @internal
 */
final class VenueFlowTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/admin/venues/venues');
    ...
    {
        $mock = $this->createMock(VenueApiService::class);
        ...
        Services::injectMock('venueApiService', $mock);
        ...
        $result->assertRedirectTo(site_url('admin/venues/venues'));
    }
}
